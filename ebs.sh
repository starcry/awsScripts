...
then
    for ((i=1; i<=$(echo $volumes | wc -w); i++)); do
        ...
        then
            ...
            read -p "rebuilding file system, this will wipe all data on drive, press the enter key to continue (if you can't find the any key I suggest purchasing a mac)"
