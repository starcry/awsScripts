"place in /usr/share/vim/vim74/colors/aidanDev.vim
"open /etc/vimrc
...
hi PreProc	    ctermfg=143         ctermbg=None        cterm=Bold
hi Search	    ctermfg=125         ctermbg=None        cterm=Bold
hi Type		    ctermfg=66         ctermbg=None        cterm=Bold
